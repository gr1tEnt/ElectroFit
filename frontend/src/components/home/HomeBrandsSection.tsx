...
const brands = [
  {
    name: "Legrand",
    series: "Valena Life",
    description: "French style and premium materials. Ideal for smart homes.",
  ...
  },
  {
    ...
    series: "Asfora",
    description: "German engineering. Reliable, durable, and cost-effective solutions.",
    ...
    <section className="border-t border-border bg-white py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-ink">Supported Manufacturers</h2>
          <p className="mt-3 text-muted">We only work with certified safety leaders</p>
        </div>
